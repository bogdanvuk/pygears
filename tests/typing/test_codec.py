...
def test_array():
    ...
    assert Array[Uint[4], 7](
        (0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7)).code() == 0x7654321
    assert Array[Uint[8], 4].decode(0xbabababa) == Array[Uint[8], 4](
        (0xba, 0xba, 0xba, 0xba))
    assert Array[Uint[4], 7].decode(0x7654321) == Array[Uint[4], 7](
