...
class FunctionMaker(object):
    ...
    def _make(self, src_templ, evaldict=None, addsource=False, **attrs):
    ...
    def make(self, body, evaldict, addsource=True, **attrs):
        ...
        return self._make(body, evaldict, addsource, **attrs)
